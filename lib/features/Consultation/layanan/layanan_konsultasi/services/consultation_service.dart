...
class ConsultationService {
  ...
  Future<String> createConsultation(
    ...
    try {
      final docRef = await _firestore.collection('konsultasi').add({
  ...
  Future<void> deleteConsultation(String consultationId) async {
    try {
      await _firestore.collection('konsultasi').doc(consultationId).delete();
    } catch (e) {
  ...
  Future<void> updateProblem(String consultationId, String problem) async {
    try {
      await _firestore.collection('konsultasi').doc(consultationId).update({
        'problem': problem,
      });
