...
class ChatServices {
  ...
  // generate ID unique for conversation
  ...
  Future<void> sendMessageToAdmin(String messages, String receiverID) async {
  ...
  Future<void> sendBase64AttachmentMessage(
    String base64Content, String receiverID, String type, String fileName) async {
  final String currentUserId = _auth.currentUser!.uid;
  final Message message = Message.newMessage(
    senderID: currentUserId,
    receiverID: adminID,
